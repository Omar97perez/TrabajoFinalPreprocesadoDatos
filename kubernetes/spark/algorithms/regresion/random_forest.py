...
if __name__ == "__main__":
    ...
    rf = RandomForestRegressor(labelCol=array[columnaFinal], featuresCol="indexedFeatures")
    ...
    rmse = dtr_evaluator.evaluate(rf_predictions)
    ...
    validation = rf_predictions.toPandas()

    fig, ax = plt.subplots()
    fig.suptitle("Random Forest Regression ( RMSE:" + str(rmse) + ")\n" + salida)
